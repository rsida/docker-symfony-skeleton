...
_symfony-init:
	...
	@if [ -f composer.json ]; then \
		...
		$(PHP) bash -c '{ echo "APP_ENV=dev"; echo "APP_SECRET=$$APP_SECRET"; echo "DATABASE_URL=mysql://$$DB_USER:$$DB_PASSWORD@mariadb:3306/$$DB_NAME?serverVersion=mariadb-11.0.0&charset=utf8mb4"; echo "MAILER_DSN=smtp://mailer:1025"; echo "DEFAULT_URI=https://$$APP_DOMAIN"; } > /var/www/html/.env.local'; \
